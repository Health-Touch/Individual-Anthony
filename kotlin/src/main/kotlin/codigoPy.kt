...
object codigoPy {
    ...
    private const val nomeArquivoPython = "monitoramento.py"
    ...
    fun monitoramento () {
        ...
        val fkEmpresa = repositorio.fkEmpresa
        val fkPlano = repositorio.fkPlano
        val fkMaquina = repositorio.fkMaquina
        val fkTipoMaquina = repositorio.fkTipoMaquina
        val fkLocal = repositorio.fkLocal
...
while True:
    ...
    insert = [
        upload, download, ping, data, fkRede, $fkMaquina, $fkEmpresa, $fkPlano, $fkTipoMaquina, $fkLocal
    ]
